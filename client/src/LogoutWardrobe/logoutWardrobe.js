...
function LogoutWardrobe({ user }) {
    ...
    return (
        <React.Fragment>
            ...
            <h1>An Introduction to our Services</h1>
            <p>Antoinette allows you to upload a personalized profile for every piece of clothing in your closet. This includes a name, image, 
